<?php
class Default_action_Dashboard_Main_7894856cb89fda1b513a7dbe0d4bbe8258e97bc7 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '</span>
    ...
    <html-template id="widgetSelector">
...
$output0 .= '
    ...
    <html-template id="dashboardModal-add">
        <form action="';
...
$output0 .= '
    ...
    <html-template id="dashboardModal-configure">
        <form action="';
